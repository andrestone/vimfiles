...
hi Normal ctermfg=188 ctermbg=235 cterm=NONE guifg=#a9b7c6 guibg=#212121 gui=NONE
hi Boolean ctermfg=103 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi Conditional ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
hi Constant ctermfg=103 ctermbg=NONE cterm=NONE guifg=#9676ac guibg=NONE gui=bold
hi Define ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi Function ctermfg=221 ctermbg=NONE cterm=bold guifg=#cc7832 guibg=NONE gui=bold
hi Identifier ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=NONE
hi Keyword ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi PreProc ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
hi Special ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi StorageClass ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi Type ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi rubyClass ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
hi rubyFunction ctermfg=222 ctermbg=NONE cterm=bold guifg=#cc7832 guibg=NONE gui=bold
...
hi rubyInclude ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi rubyEscape ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
hi rubyControl ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
hi rubyClassVariable ctermfg=NONE ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi rubyOperator ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
hi rubyException ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi jsFunction ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
"hi jsNoise ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
hi jsDocComment ctermfg=65 ctermbg=NONE cterm=bold guifg=#5e8759 guibg=NONE gui=bold
hi jsFunctionKey ctermfg=222 ctermbg=NONE cterm=bold guifg=#cc7832 guibg=NONE gui=bold
hi jsCommonJs ctermfg=222 ctermbg=NONE cterm=bold guifg=#cc7832 guibg=NONE gui=bold
"hi jsParen ctermfg=222 ctermbg=NONE cterm=bold guifg=#cc7832 guibg=NONE gui=bold
...
hi javaScriptFunction ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
...
" Extra typescript highliting
hi typescriptDocComment ctermfg=65 ctermbg=NONE cterm=bold guifg=#5e8759 guibg=NONE gui=bold

" Extra Markdown highlighing.
hi markdownHeadingDelimiter ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold
hi markdownH1 ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=NONE
hi markdownH2 ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=NONE
hi markdownH3 ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=NONE
hi markdownH4 ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=NONE
hi markdownH5 ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=NONE
hi markdownH6 ctermfg=222 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=NONE
...
hi vimCommand ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=NONE
...
hi pythonOperator ctermfg=172 ctermbg=NONE cterm=NONE guifg=#cc7832 guibg=NONE gui=bold

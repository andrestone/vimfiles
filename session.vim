...
nnoremap  cd :cd %:h:pwd
nnoremap  f4 :exec 'syn list '.synIDattr(synID(line('.'), col('.'), 0), 'name')
nnoremap  f3 :echo map(synstack(line('.'), col('.')), 'synIDattr(v:val, "name")')
nnoremap  f2 :echo ("hi<" . synIDattr(synID(line("."),col("."),1),"name") . '> trans<' . synIDattr(synID(line("."),col("."),0),"name") . "> lo<" . synIDattr(synIDtrans(synID(line("."),col("."),1)),"name") . ">")
nnoremap  f1 :echo synIDattr(synID(line('.'), col('.'), 0), 'name')
nnoremap  in :IndentGuidesToggle
...
nmap <F10> :call vimspector#Reset()
...
set runtimepath=
set runtimepath+=~/.vim
set runtimepath+=~/.vim/pack/andrestone/start/vim-velocity
set runtimepath+=~/.vim/pack/andrestone/start/vim-SyntaxRange
set runtimepath+=~/.vim/pack/andrestone/start/vim-snippets
set runtimepath+=~/.vim/pack/andrestone/start/vim-obsession
set runtimepath+=~/.vim/pack/andrestone/start/vim-markdown
set runtimepath+=~/.vim/pack/andrestone/start/vim-jsx-pretty
set runtimepath+=~/.vim/pack/andrestone/start/vim-indent-guides
set runtimepath+=~/.vim/pack/andrestone/start/vim-graphql
set runtimepath+=~/.vim/pack/andrestone/start/vim-gitgutter
set runtimepath+=~/.vim/pack/andrestone/start/vim-fugitive
set runtimepath+=~/.vim/pack/andrestone/start/vim-css-color
set runtimepath+=~/.vim/pack/andrestone/start/vim-commentary
set runtimepath+=~/.vim/pack/andrestone/start/vim-airline
set runtimepath+=~/.vim/pack/andrestone/start/undotree
set runtimepath+=~/.vim/pack/andrestone/start/nerdtree
set runtimepath+=~/.vim/pack/andrestone/start/gruvbox
set runtimepath+=~/.vim/pack/andrestone/start/fzf.vim
set runtimepath+=~/.vim/pack/andrestone/start/fzf
set runtimepath+=~/.vim/pack/andrestone/start/coc.nvim
set runtimepath+=~/.vim/pack/andrestone/start/blamer.nvim
set runtimepath+=~/.vim/pack/andrestone/start/auto-pairs
set runtimepath+=~/.vim/pack/andrestone/start/vimspector
...
set runtimepath+=~/.vim/pack/andrestone/start/vim-jsx-pretty/after
set runtimepath+=~/.vim/pack/andrestone/start/vim-graphql/after
set runtimepath+=~/.vim/pack/andrestone/start/vim-css-color/after
